...
class SeederProduccion extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // ETIQUETAS 
        $etiquetas = [
            'NATURALEZA','ANIMALES','RETRATO','PAISAJE','TECNOLOGIA',
            'FLORES','FAMILIAR','PLAYA','COCHES','PRODUCTO',
            'NOCTURNA','CIUDADES','VIAJES','MODA','SUBMARINA',
        ];
        ...
        $users = [
            [
                'email' => 'invitado@opta.com','telefono' => '611111111',
                'nombre' => 'Invitado','apellidos' => 'Apellidos 01',
                'direccion' => 'C/ Java 23','password' => Hash::make('invitado'),
                'dni' => '31111111A','role_id' => 1, 'marcado_eliminar' => false,
            ],
            [
                'email' => 'admin@opta.com','telefono' => '611111112',
                'nombre' => 'Admin','apellidos' => 'Apellidos 02',
                'direccion' => 'Plaza Fortran 12','password' => Hash::make('admin'),
                'dni' => '31111112A','role_id' => 4, 'marcado_eliminar' => false,
            ],
            [
                'email' => 'empleado@opta.com','telefono' => '611111113',
                'nombre' => 'Empleado','apellidos' => 'Apellidos 03',
                'direccion' => 'C/ Basic S/N','password' => Hash::make('empleado'),
                'dni' => '31111113A','role_id' => 3, 'marcado_eliminar' => false,
            ],
            [
                'email' => 'cliente1@opta.com','telefono' => '611111114',
                'nombre' => 'Cliente1','apellidos' => 'Apellidos 04',
                'direccion' => 'Boulevard Python 54','password' => Hash::make('cliente1'),
                'dni' => '31111114A','role_id' => 2, 'marcado_eliminar' => false,
            ],
            [
                'email' => 'cliente2@opta.com','telefono' => '611111115',
                'nombre' => 'Cliente2','apellidos' => 'Apellidos 05',
                'direccion' => 'Vereda del Ensamblador 1','password' => Hash::make('cliente2'),
                'dni' => '31111115A','role_id' => 2, 'marcado_eliminar' => false,
            ],
            [
                'email' => 'cliente3@opta.com','telefono' => '611111116',
                'nombre' => 'Cliente3','apellidos' => 'Apellidos 06',
                'direccion' => 'Plaza COBOL 30','password' => Hash::make('cliente3'),
                'dni' => '31111116A','role_id' => 2, 'marcado_eliminar' => false,
            ],
            [
                'email' => 'cliente4@opta.com','telefono' => '611111117',
                'nombre' => 'Cliente4','apellidos' => 'Apellidos 07',
                'direccion' => 'C/ Pascal 64','password' => Hash::make('cliente4'),
                'dni' => '31111117A','role_id' => 2, 'marcado_eliminar' => true,
            ],
            [
                'email' => 'clientefantasma1@opta.com','telefono' => '611111118',
                'nombre' => 'ClienteFantasma1','apellidos' => 'Apellidos 08',
                'direccion' => 'Trocha del JavaScript 1970','password' => Hash::make('clientefantasma1'),
                'dni' => '31111118A','role_id' => 2, 'marcado_eliminar' => false,
            ],
            [
                'email' => 'clientefantasma2@opta.com','telefono' => '611111119',
                'nombre' => 'ClienteFantasma2','apellidos' => 'Apellidos 09',
                'direccion' => 'Avda. Kotlin S/N','password' => Hash::make('clientefantasma2'),
                'dni' => '31111119A','role_id' => 2, 'marcado_eliminar' => false,
            ],
            [
                'email' => 'clienteprueba@opta.com','telefono' => '611111120',
                'nombre' => 'ClientePrueba','apellidos' => 'Apellidos 10',
                'direccion' => 'Boulevard PHP 21','password' => Hash::make('clientePrueba'),
                'dni' => '31111120A','role_id' => 2, 'marcado_eliminar' => true,
            ],
        ];
