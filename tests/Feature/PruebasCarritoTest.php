...
class PruebasCarritoTest extends TestCase
{
     ...
     */
    public function test_fallo_cantidad_cero(): void
    {
     ...
     */
    public function test_fallo_cantidad_negativa(): void
    {
        $foto = Fotografia::factory()->create();
        $formato = Formato::factory()->create();
        $soporte = Soporte::factory()->create(['disponibilidad' => true]);
     ...
     */
    public function test_fallo_formato_inexistente(): void
    {
        $foto = Fotografia::factory()->create();
        $soporte = Soporte::factory()->create(['disponibilidad' => true]);
     ...
     */
    public function test_fallo_soporte_inexistente(): void
    {
        $foto = Fotografia::factory()->create();
        $formato = Formato::factory()->create();
     ...
     */
    public function test_fallo_fotografia_inexistente(): void
    {
     ...
     */
    public function test_guarda_item_valido(): void
    {
        $foto = Fotografia::factory()->create();
     ...
     */
    public function test_fallo_limite15_items(): void
    {
        $foto = Fotografia::factory()->create();
        $formato = Formato::factory()->create(['ancho' => 10, 'alto' => 10]);
        $soporte = Soporte::factory()->create(['disponibilidad' => true, 'precio' => 1.00]);
     ...
     */
    public function test_fallo_carrito_vacio(): void
    {
     ...
     */
    public function test_procesa_carrito_correcto(): void
    {
        $user = User::factory()->create();
        $foto = Fotografia::factory()->create();
        $formato = Formato::factory()->create();
     ...
     */
    public function test_fallo_fotografia_invalida(): void
    {
        $user = User::factory()->create();
        $formato = Formato::factory()->create();
        $soporte = Soporte::factory()->create();
